...
* **⚖️ Fitness, Fatigue & Form:** Implements the Banister TRIMP (Training Impulse) model to calculate and visualize your physiological state:
...
```text
├── Home.py                             # Main Streamlit entry point (Macro Dashboard)
...
│   └── [activity_files].gpx / .fit     # Raw granular activity files
...
└── utils/                              # Core pipeline logic
    ...
    ├── functions.py                    # TRIMP calculations and data transformations
