...
try:
    ...
    selected_type = st.sidebar.selectbox("Select Sport", activity_types)
    ...
    with st.spinner("Parsing localized spatial telemetry..."):
        time_series_df = parse_raw_gpx(target_filename)
